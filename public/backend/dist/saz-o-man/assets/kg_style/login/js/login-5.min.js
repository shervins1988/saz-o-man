var Login = function () {
    var r = function () {
        $(".login-form").validate({
            ...
            messages: {username: {required: "Email is required."}, password: {required: "Password is required."}},
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["../backend/dist/demo5/assets/app/media/img/bg/bg1.jpg", "../backend/dist/demo5/assets/app/media/img/bg/bg2.jpg", "../backend/dist/demo5/assets/app/media/img/bg/bg3.jpg"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
