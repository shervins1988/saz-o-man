...
@section('content')
    ...
    <div class="m-portlet">
        ...
        {!! Form::open(['method'=>'POST','action'=>'Backend\CategoryController@store','class'=>'m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed','files'=>'true']) !!}
        <div class="m-portlet__body">
            <div class="form-group m-form__group row ">
                    ...
                    <select name="category_parent" id="" class="form-control">
                        ...
                        @foreach($category_menus as $category)
                            ...
                            @if(count($category->childrenRecursive) > 0)
                                @include('Backend.partials.category',['category_menus' => $category->childrenRecursive, 'level'=>1])
                            @endif
                        @endforeach
                    </select>
                    <span
                ...
                <div class="col-lg-4">
                    ...
                    {!! Form::text('title',null,['placeholder' => 'نام دسته بندی را وارد نمایید...','class'=>'form-control m-input']) !!}
