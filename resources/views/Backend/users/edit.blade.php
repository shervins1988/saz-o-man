...
@section('content')
    <br>
        <!--begin::Form-->
        <!--begin::Form-->
    @include('Backend.admin.section.errors')
        {!! Form::model($user,['method'=>'PATCH','action'=>['Backend\UserController@update',$user->id],'class'=>'m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed','files'=>'true']) !!}
...
{{--                    <div class="btn-group" style="width: 100%;">
                        <button type="button" class="multiselect dropdown-toggle mt-multiselect btn btn-default"  data-toggle="dropdown" style="width: 100%; overflow: hidden; text-overflow: ellipsis;" aria-expanded="false">
                            <span class="multiselect-selected-text"  name="roles[]" id="roles">انتخاب کنید</span>
                            <b class="caret"></b></button>
                        <ul class="multiselect-container dropdown-menu">
                            @foreach($roles as $role)
                                <li  name="roles[]" id="roles">
                                    <label class="m-checkbox m-checkbox--solid m-checkbox--success">
                                        <input type="checkbox"  name="roles[]" id="roles">{{$role}}
                                        <span></span>
                                    </label>
                                </li>
                            @endforeach
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="m-input-icon m-input-icon--right">
                        <input type="password" id="password" name="password" value="" class="form-control m-input" placeholder="رمز عبور خود را وارد نمایید...">
            ...
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <button   onclick="{{route('users.index')}}" class="btn btn-danger">لغو</button>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
