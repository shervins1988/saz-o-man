...
@section('content')
    <br>
    @if(Session::has('$add_attributesValue'))
        <div class="m-alert__text" >
            {{Session('$add_attributesValue')}}
        </div>
    @endif

    @if(Session::has('$upd_attributesValue'))
        <div class="m-alert__text" >
            {{Session('$upd_attributesValue')}}
        </div>
    @endif

    @if(Session::has('$del_attributesValue'))
        <div class="m-alert__text" >
            {{Session('$del_attributesValue')}}
        </div>
    @endif
                        ...
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                {{--                                <li class="m-portlet__nav-item">
                                                                    <a href="{{route('articles.index')}}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                                                        <span>
                                                    ...
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="{{route('attributes-value.create')}}" class="m-nav__link">
                                                                    <i class="m-nav__link-icon flaticon-share"></i>
                                                                    <span class="m-nav__link-text">ایجاد مقادیر ویژگی جدید</span>
                                                                </a>
                                                            </li>
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20">
                            <div class="row m--margin-bottom-20 offset-3">
                                <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
                                    ...
                                    <input type="text" class="form-control m-input" placeholder="نام مقدار ویژگی را وارد نمایید..." data-col-index="0">
                                </div>
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc" tabindex="0" aria-controls="m_table_1" rowspan="1"
                                            ...
                                            aria-label="Agent: activate to sort column descending">نام ویژگی
                                        </th>

                                        <th class="sorting_asc" tabindex="0" aria-controls="m_table_1" rowspan="1"
                                            colspan="1" style="width: 60px;" aria-sort="ascending"
                                            aria-label="Agent: activate to sort column descending">گروه بندی ویژگی
                                        </th>
                                    ...
                                    @foreach($attributesValue as $attribute)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1" tabindex="0"> {{$attribute->id}}</td>
                                            <td> {{$attribute->title}}</td>
                                            <td> {{$attribute->attributeGroup->title}}</td>
                                            <td nowrap="">
                                                <a href="{{route('attributes-value.edit',$attribute->id)}}"
                                                   class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="ویرایش">
                                                    <i class="la la-edit"></i>
                                                </a>
                                                {!! Form::open(['method'=>'DELETE','action'=>['Backend\AttributeValueController@destroy',$attribute->id],'style'=>'display:inline-block']) !!}
                                                <button
