...
@section('content')
    ...
    @if(Session::has('$add_attributesGroup'))
        <div class="m-alert__text" >
            {{Session('$add_attributesGroup')}}
        </div>
    @endif

    @if(Session::has('$delete_attributesGroup'))
        <div class="m-alert__text" >
            {{Session('$delete_attributesGroup')}}
        </div>
    @endif

    @if(Session::has('$update_attributesGroup'))
        <div class="m-alert__text" >
            {{Session('$update_attributesGroup')}}
        </div>
    @endif
    <style>
                                                    ...
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">
                                                            ...
                                                            <li class="m-nav__item">
                                                                <a href="{{route('attributes-group.create')}}" class="m-nav__link">
                                                                    <i class="m-nav__link-icon flaticon-share"></i>
                                                                    <span class="m-nav__link-text">ایجاد ویژگی جدید</span>
                                                                </a>
                                                            </li>
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20">
                            <div class="row m--margin-bottom-20 offset-3">
                                <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
                                    ...
                                    <input type="text" class="form-control m-input" placeholder="نام ویژگی را وارد نمایید..." data-col-index="0">
                                </div>
                            ...
                            <div class="row">
                                <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc" tabindex="0" aria-controls="m_table_1" rowspan="1"
                                            colspan="1" style="width: 60px;" aria-sort="ascending"
                                            aria-label="Agent: activate to sort column descending">نوع ویژگی
                                        </th>
                                    ...
                                    @foreach($attributesGroup as $attribute)
                                        <tr role="row" class="odd">
                                            ...
                                            <td nowrap="">
                                                <a href="{{route('attributes-group.edit',$attribute->id)}}"
                                                   class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="ویرایش">
                                                    <i class="la la-edit"></i>
                                                </a>
                                                {!! Form::open(['method'=>'DELETE','action'=>['Backend\AttributGroupController@destroy',$attribute->id],'style'=>'display:inline-block']) !!}
                                                <button
