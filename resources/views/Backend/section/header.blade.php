...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <!-- begin::Header -->
        ...
        <div class="m-header__top">
                        ...
                        <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="index.html" class="m-brand__logo-wrapper">
                                    <img alt="" src="{{url('backend/dist/saz-o-man/assets/kg_style/media/img/logo/logo.png')}}"/>
                                </a>
                            </div>
          ...
          <span class="m-dropdown__arrow m-dropdown__arrow--left m-dropdown__arrow--adjust" style="right: auto;left: 51.5px;"></span>
                                                    ...
                                                    <ul class="m-nav">
                                                        ...
                                                        <li class="m-nav__item">
                                                         {{--   <a href="{{route('users.index')}}" class="m-nav__link">--}}
                                                                ...
                                                                <span class="m-menu__link-badge" style="margin-right: -14px;">
                                ...
                                <ul class="m-topbar__nav m-nav m-nav--inline">
                                    <li class="m-nav__item m-topbar__notifications m-topbar__notifications--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-center 	m-dropdown--mobile-full-width" m-dropdown-toggle="click" m-dropdown-persistent="1">
                                        ...
                                        <div class="m-dropdown__wrapper">
                                            ...
                                            <div class="m-dropdown__inner">
                                                <div class="m-dropdown__header m--align-center" style="background: url(dist/saz-o-man/assets/app/media/img/miisc/notification_bg.jpg); background-size: cover;">
	...
	12 کاربر جدید ثبت نام کرده اند
                                    ...
                                    <li class="m-nav__item m-topbar__quick-actions m-topbar__quick-actions--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push m-dropdown--mobile-full-width m-dropdown--skin-light"  m-dropdown-toggle="click">
                                        ...
                                        <div class="m-dropdown__wrapper">
                                            ...
                                            <div class="m-dropdown__inner">
                                                <div class="m-dropdown__header m--align-center" style="background: url('dist/saz-o-man/assets/app/media/img/miisc/quick_actions_bg.jpg'); background-size: cover;">
															<span class="m-dropdown__header-title">
																عملیات های سریع
															</span>
                                                    <span class="m-dropdown__header-subtitle">
	...
	<img src="{{url('backend/dist/saz-o-man/assets/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>
													</span>
                                        </a>
                                        <div class="m-dropdown__wrapper">
                                            <span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
                                            <div class="m-dropdown__inner">
                                                <div class="m-dropdown__header m--align-center" style="background: url(dist/saz-o-man/assets/app/media/img/miisc/user_profile_bg.jpg); background-size: cover;">
                                                    <div class="m-card-user m-card-user--skin-dark">
                                                        <div class="m-card-user__pic">
        <img src="{{url('backend/dist/saz-o-man/assets/app/media/img/users/user4.jpg')}}" class="m--img-rounded m--marginless" alt=""/>
                                                        </div>
 ...
 <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                ...
                                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                    ...
                                                    <ul class="m-menu__subnav">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            {{--<a  href="{{route('upload-media.index')}}" class="m-menu__link ">--}}
																		<span class="m-menu__link-text">
																			لیست رسانه ها
																		</span>
                                                            </a>
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            {{--<a  href="{{route('upload-media.create')}}" class="m-menu__link ">--}}
																		<span class="m-menu__link-text">
																			ایجاد رسانه
																		</span>

                                                                <span class="m-menu__link-badge" style="margin-right: -8px;">
																		<span class="m-badge m-badge--success">
                                               2
																		</span>
																	</span>
              ...
              <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                ...
                                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                    ...
                                                    <ul class="m-menu__subnav">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{route('attributes-group.index')}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			لیست ویژگی ها
																		</span>
                                                            </a>
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{route('attributes-group.create')}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			ایجاد ویژگی
																		</span>
              ...
              <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                ...
                                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                    ...
                                                    <ul class="m-menu__subnav">
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{route('attributes-value.index')}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{route('attributes-value.create')}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			ایجاد مقادیر ویژگی
																		</span>
                                            ...
                                            <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                ...
                                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                    ...
                                                    <ul class="m-menu__subnav">
                                                        ...
                                                        <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                            ...
                                                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                                ...
                                                                <ul class="m-menu__subnav">
                                                                    ...
                                                                    <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                                        <a  href="{{route('categories-menu.index')}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			دسته بندی والد
																		</span>
                                                                    ...
                                                                    <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                                        <a  href="{{--{{route('sub-categories-menu.index')}}--}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			دسته بندی زیر منو
																		</span>
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{--{{route('categories-blog.index')}}--}}" class="m-menu__link ">
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{--{{route('categories-article.index')}}--}}" class="m-menu__link ">
                                                                <i class="m-menu__link-icon flaticon-list-2"></i>
                                                                <span class="m-menu__link-text">
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{--{{route('categories-book.index')}}--}}" class="m-menu__link ">
                                                                <i class="m-menu__link-icon flaticon-list-2"></i>
                                                                <span class="m-menu__link-text">
																			لیست دسته بندی کتاب ها
																		</span>
                                            ...
                                            <li class="m-menu__item  m-menu__item--submenu"  m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
                                                ...
                                                <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                                    ...
                                                    <ul class="m-menu__subnav">
                                                        ...
                                                        <li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
                                                            <a  href="{{--{{route('notics.index')}}--}}" class="m-menu__link ">
																		<span class="m-menu__link-text">
																			لیست یادداشت ها
																		</span>
                        ...
                        <form class="m-header-search__form">
                            <div class="m-header-search__wrapper">
                                ...
                                <span class="m-header-search__input-wrapper">
											<input autocomplete="off" type="text" name="q" class="m-header-search__input" value="" placeholder="جستجو..." id="m_quicksearch_input">
										</span>
